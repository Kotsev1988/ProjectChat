...
public class ForwardFragment extends Fragment {
    private RecyclerView mForwardRecycler;
    private ForwardListAdapter forwardListAdapter;
    List<Contact_users> contactForwardList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_forward, container, false);
