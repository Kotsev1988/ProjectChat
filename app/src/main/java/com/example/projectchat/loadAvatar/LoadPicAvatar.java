...
public class LoadPicAvatar extends Worker {
    String lineend = "\r\n";
    String twohyphens = "--";
    final String boundary = "*****";
    URL url = null;
    HttpURLConnection urlConnection = null;
    String urlPic = "http://192.168.0.27/addAvatar.php/";
    //String urlPic="http://62.183.83.166:55010/addAvatar.php";
    DataOutputStream outputStream = null;

    public LoadPicAvatar(Context context, WorkerParameters parameters) {
    ...
    public Result doWork() {
        try {
            ...
            try {
                json.put("avatarfolder", getInputData().getString("userjid"));
                json.put("avatarname", getInputData().getString("filename"));
